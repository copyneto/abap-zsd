...
"!<p><strong>Data:</strong> 25/04/2022</p>
CLASS zclsd_auth_zsdmtable DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS gc_object TYPE xuobject VALUE 'ZSDMTABLE'.
...
CLASS ZCLSD_AUTH_ZSDMTABLE IMPLEMENTATION.
