*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_ICMSDIF
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_ICMSDIF        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_ICMSDIF'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_ICMSDIF_EXTRACT
TOTAL = ZVSD_ICMSDIF_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_ICMSDIF'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_ICMSDIF-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_ICMSDIF_EXTRACT
TOTAL = ZVSD_ICMSDIF_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_ICMSDIF-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_ICMSDIF'
...
TOTAL = ZVSD_ICMSDIF_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_ICMSDIF-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_ICMSDIF-UPD_FLAG NE SPACE.
