class ZCLSD_CX_FMT_CRIAR_CONTRATO definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA6 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA6 optional
...
CLASS ZCLSD_CX_FMT_CRIAR_CONTRATO IMPLEMENTATION.
