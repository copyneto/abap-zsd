class ZCLSD_CX_FMT_CONSULTA_ATIVO definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA7 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA7 optional
...
CLASS ZCLSD_CX_FMT_CONSULTA_ATIVO IMPLEMENTATION.
