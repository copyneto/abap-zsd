class ZCLSD_CX_FMT_CRIACAO_ORDEM_VE1 definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA1 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA1 optional
...
CLASS ZCLSD_CX_FMT_CRIACAO_ORDEM_VE1 IMPLEMENTATION.
