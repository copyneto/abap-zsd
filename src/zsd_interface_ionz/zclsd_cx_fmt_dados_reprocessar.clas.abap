class ZCLSD_CX_FMT_DADOS_REPROCESSAR definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA2 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA2 optional
...
CLASS ZCLSD_CX_FMT_DADOS_REPROCESSAR IMPLEMENTATION.
