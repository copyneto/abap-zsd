class ZCLSD_CX_FMT_ENTRAR_NOTA_FISCA definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA9 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA9 optional
...
CLASS ZCLSD_CX_FMT_ENTRAR_NOTA_FISCA IMPLEMENTATION.
