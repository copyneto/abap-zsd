class ZCLSD_CX_FMT_FATURA definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA10 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA10 optional
...
CLASS ZCLSD_CX_FMT_FATURA IMPLEMENTATION.
