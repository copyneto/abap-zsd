class ZSDCX_FMT_CADASTROS definition
  public
...
public section.
  ...
  data STANDARD type ZSDEXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZSDEXCHANGE_FAULT_DATA optional
...
CLASS ZSDCX_FMT_CADASTROS IMPLEMENTATION.
