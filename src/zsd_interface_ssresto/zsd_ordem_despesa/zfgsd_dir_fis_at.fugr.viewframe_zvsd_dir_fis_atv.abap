*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_DIR_FIS_ATV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_DIR_FIS_ATV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_DIR_FIS_ATV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_DIR_FIS_ATV_EXTRACT
TOTAL = ZVSD_DIR_FIS_ATV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_DIR_FIS_ATV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_DIR_FIS_ATV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_DIR_FIS_ATV_EXTRACT
TOTAL = ZVSD_DIR_FIS_ATV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_DIR_FIS_ATV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_DIR_FIS_ATV'
...
TOTAL = ZVSD_DIR_FIS_ATV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_DIR_FIS_ATV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_DIR_FIS_ATV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_DIR_FIS_ATV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_DIR_FIS_ATV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_DIR_FIS_ATV_EXTRACT
TOTAL = ZVSD_DIR_FIS_ATV_TOTAL
