class ZCLSD_CX_FMT_VENDA_CANCELAMENT definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA4 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA4 optional
...
CLASS ZCLSD_CX_FMT_VENDA_CANCELAMENT IMPLEMENTATION.
