class ZSD_CX_FMT_VENDA_ORDEM definition
  public
...
public section.
  ...
  data STANDARD type ZSD_EXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZSD_EXCHANGE_FAULT_DATA optional
...
CLASS ZSD_CX_FMT_VENDA_ORDEM IMPLEMENTATION.
