class ZCLSD_CX_FMT_DEVOLUCAO_MATERIA definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA5 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA5 optional
...
CLASS ZCLSD_CX_FMT_DEVOLUCAO_MATERIA IMPLEMENTATION.
