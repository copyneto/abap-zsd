class ZCLSD_CL_SI_CRIAR_ORDEM_VENDA definition
  public
  create public .

public section.

  interfaces ZCLSD_II_SI_CRIAR_ORDEM_VENDA .
protected section.
private section.
ENDCLASS.
...
CLASS ZCLSD_CL_SI_CRIAR_ORDEM_VENDA IMPLEMENTATION.


  METHOD zclsd_ii_si_criar_ordem_venda~si_criar_ordem_venda_in.
