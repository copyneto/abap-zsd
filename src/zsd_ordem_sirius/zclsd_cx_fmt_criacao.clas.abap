class ZCLSD_CX_FMT_CRIACAO definition
  public
...
public section.
  ...
  data STANDARD type ZCLSD_EXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLSD_EXCHANGE_FAULT_DATA optional
...
CLASS ZCLSD_CX_FMT_CRIACAO IMPLEMENTATION.
