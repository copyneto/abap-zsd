...
@EndUserText.label: 'Busca dos valores do dominio MOTDESICMS'
...
define view entity ZI_SD_DOMAIN_MOTDESICMS as select from dd07l as Domain
...
where
      Domain.domname  = 'J_1B_ICMS_EXEM_REASON'
