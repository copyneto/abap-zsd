class ZCLSD_COCKPIT_DEVOLUC_MPC definition
  public
...
public section.
  ...
  types:
     TS_FILE_SHOW type ZTSD_ANEXO_DEV .
  types:
TT_FILE_SHOW type standard table of TS_FILE_SHOW .
  types:
...
TT_FILE type standard table of TS_FILE .
  ...
  constants GC_FILE_SHOW type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'file_show' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCLSD_COCKPIT_DEVOLUC_MPC=====CP' ##NO_TEXT.

  methods DEFINE_FILE_SHOW
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCLSD_COCKPIT_DEVOLUC_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSD_COCKPIT_DEVOLUCAO_ANEXO1_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZTSD_ANEXO_DEV'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'fileShowSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLSD_COCKPIT_DEVOLUC_MPC=>TS_LAYOUT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20221114210606'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'file_show'.                            "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'file_show' iv_def_entity_set = abap_true ). "#EC NOTEXT
lo_entity_type->set_is_media( 'X' ).  "#EC NOTEXT
