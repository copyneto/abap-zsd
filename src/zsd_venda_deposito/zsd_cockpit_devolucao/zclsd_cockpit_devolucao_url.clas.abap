CLASS zclsd_cockpit_devolucao_url DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS: BEGIN OF gc_values,
                 ...
                 docnum                 TYPE char30   VALUE 'NotaFiscal',
                 ...
                 displaydocnum          TYPE char60   VALUE 'zzdisplay',
                 changedocnum           TYPE char60   VALUE 'zzchange',
                 ...
                 j_1bnfdoc_docnum       TYPE ihttpnam VALUE 'NumeroDocumento',
...
CLASS zclsd_cockpit_devolucao_url IMPLEMENTATION.
  METHOD if_sadl_exit_calc_element_read~calculate.

    DATA: lt_calculated_data TYPE STANDARD TABLE OF zc_sd_cockpit_devolucao,
    ...
    LOOP AT lt_calculated_data ASSIGNING FIELD-SYMBOL(<fs_data>).
      ...
      " DocNum
      APPEND VALUE #( name  = gc_values-j_1bnfdoc_docnum
                      value = <fs_data>-DocNum ) TO lt_parameters.

      <fs_data>-URL_j1b3n = cl_lsapi_manager=>create_flp_url( object     = gc_values-docnum
                                                             action     = gc_values-changedocnum
                                                             parameters = lt_parameters ).
      REFRESH lt_parameters.
