...
define view ZI_SD_CKPT_FAT_DISP_ESTOQUE
  ...
  association [0..1] to ZI_SD_VERIF_DISP_ESTOQUE as _CheckStock      on  _CheckStock.Material        = _SalesOrderItem.Material
                                                                     and _CheckStock.Plant           = _SalesOrderItem.Plant
                                                                     and _CheckStock.StorageLocation = _SalesOrderItem.StorageLocation
...
//////           end                                                                                                                                  as StockDfMardExist,
      ...
      //      cast(  _MaterialStock.labst  as abap.dec(13,3) ) + cast( _MaterialStockDf.labst  as abap.dec(13,3) ) -
      //      cast( _CheckStock.QtdRemessa as abap.dec(15,3) ) - cast( _CheckStock.QtdOrdem as abap.dec(15,3) )           as Saldo,
      //
      //      cast(  _MaterialStock.labst  as abap.dec(13,3) ) -
      //      cast( _CheckStock.QtdRemessa as abap.dec(15,3) ) - cast( _CheckStock.QtdOrdem as abap.dec(15,3) )           as SaldoLivre,
      //
      //      cast( _MaterialStockDf.labst  as abap.dec(13,3) ) - cast( _SalesOrderItem.OrderQuantity as abap.dec(15,3) ) as SaldoDf
}
