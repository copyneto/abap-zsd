CLASS zclsd_cockpit_remessa_url DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zclsd_cockpit_remessa_url IMPLEMENTATION.
  METHOD if_sadl_exit_calc_element_read~calculate.

    DATA: lt_calculated_data TYPE STANDARD TABLE OF zc_sd_cockpit_remessa,
    ...
    LOOP AT lt_calculated_data ASSIGNING FIELD-SYMBOL(<fs_data>).
      ...
      APPEND VALUE #( name  = gc_values-vbak_vbeln
                      value = <fs_data>-salesdocument )  TO lt_parameters.
