...
define view entity zi_sd_delivery_filtered
  as select from    zi_sd_delivery_BR_NFItem as _SDDeliveryNFItem
  association [0..1] to I_BR_NFDocument as _NFHeader on _NFHeader.BR_NotaFiscal = $projection.BR_NotaFiscal
...
key DeliveryDocument,
 SalesDocumentFirstItem,
    ...
    BillingDocument,
    BillingDocumentItem,    
    _SDDeliveryNFItem._NFItem.BR_NotaFiscal as BR_NotaFiscal,
