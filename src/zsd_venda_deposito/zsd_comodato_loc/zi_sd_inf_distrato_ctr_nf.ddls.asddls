...
define view entity ZI_SD_INF_DISTRATO_CTR_NF
  as select from    matdoc as _matdoc

    join            ser03  as _ser03 on  _matdoc.mblnr = _ser03.mblnr
                                     and _matdoc.mjahr = _ser03.mjahr
                                     and _matdoc.zeile = _ser03.zeile
