*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_GNRE_CONFIG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_GNRE_CONFIG    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_GNRE_CONFIG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_GNRE_CONFIG_EXTRACT
TOTAL = ZVSD_GNRE_CONFIG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_GNRE_CONFIG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_GNRE_CONFIG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_GNRE_CONFIG_EXTRACT
TOTAL = ZVSD_GNRE_CONFIG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_GNRE_CONFIG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_GNRE_CONFIG'
...
TOTAL = ZVSD_GNRE_CONFIG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_GNRE_CONFIG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_GNRE_CONFIG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_GNRE_CONFIG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_GNRE_CONFIG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_GNRE_CONFIG_EXTRACT
TOTAL = ZVSD_GNRE_CONFIG_TOTAL
