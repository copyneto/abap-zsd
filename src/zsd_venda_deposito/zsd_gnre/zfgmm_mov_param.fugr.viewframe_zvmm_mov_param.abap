*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVMM_MOV_PARAM
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVMM_MOV_PARAM      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVMM_MOV_PARAM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVMM_MOV_PARAM_EXTRACT
TOTAL = ZVMM_MOV_PARAM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVMM_MOV_PARAM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVMM_MOV_PARAM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVMM_MOV_PARAM_EXTRACT
TOTAL = ZVMM_MOV_PARAM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVMM_MOV_PARAM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVMM_MOV_PARAM'
...
TOTAL = ZVMM_MOV_PARAM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVMM_MOV_PARAM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVMM_MOV_PARAM-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVMM_MOV_PARAM'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVMM_MOV_PARAM-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVMM_MOV_PARAM_EXTRACT
TOTAL = ZVMM_MOV_PARAM_TOTAL
