*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_CALC_DIFAL
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_CALC_DIFAL     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_CALC_DIFAL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_CALC_DIFAL_EXTRACT
TOTAL = ZVSD_CALC_DIFAL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_CALC_DIFAL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_CALC_DIFAL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_CALC_DIFAL_EXTRACT
TOTAL = ZVSD_CALC_DIFAL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_CALC_DIFAL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_CALC_DIFAL'
...
TOTAL = ZVSD_CALC_DIFAL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_CALC_DIFAL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_CALC_DIFAL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_CALC_DIFAL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_CALC_DIFAL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_CALC_DIFAL_EXTRACT
TOTAL = ZVSD_CALC_DIFAL_TOTAL
