*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_CBENEF
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_CBENEF         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_CBENEF'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_CBENEF_EXTRACT
TOTAL = ZVSD_CBENEF_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_CBENEF'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_CBENEF-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_CBENEF_EXTRACT
TOTAL = ZVSD_CBENEF_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_CBENEF-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_CBENEF'
...
TOTAL = ZVSD_CBENEF_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_CBENEF-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_CBENEF-UPD_FLAG NE SPACE.
