*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_FECOP_ICMS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_FECOP_ICMS     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_FECOP_ICMS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_FECOP_ICMS_EXTRACT
TOTAL = ZVSD_FECOP_ICMS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_FECOP_ICMS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_FECOP_ICMS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_FECOP_ICMS_EXTRACT
TOTAL = ZVSD_FECOP_ICMS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_FECOP_ICMS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_FECOP_ICMS'
...
TOTAL = ZVSD_FECOP_ICMS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_FECOP_ICMS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_FECOP_ICMS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_FECOP_ICMS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_FECOP_ICMS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_FECOP_ICMS_EXTRACT
TOTAL = ZVSD_FECOP_ICMS_TOTAL
