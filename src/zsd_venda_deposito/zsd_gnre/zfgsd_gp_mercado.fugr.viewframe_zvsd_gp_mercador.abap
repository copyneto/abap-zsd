*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_GP_MERCADOR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_GP_MERCADOR    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_GP_MERCADOR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_GP_MERCADOR_EXTRACT
TOTAL = ZVSD_GP_MERCADOR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_GP_MERCADOR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_GP_MERCADOR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_GP_MERCADOR_EXTRACT
TOTAL = ZVSD_GP_MERCADOR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_GP_MERCADOR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_GP_MERCADOR'
...
TOTAL = ZVSD_GP_MERCADOR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_GP_MERCADOR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_GP_MERCADOR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_GP_MERCADOR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_GP_MERCADOR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_GP_MERCADOR_EXTRACT
TOTAL = ZVSD_GP_MERCADOR_TOTAL
