*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_INCL_USER
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_INCL_USER      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_INCL_USER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_INCL_USER_EXTRACT
TOTAL = ZVSD_INCL_USER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_INCL_USER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_INCL_USER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_INCL_USER_EXTRACT
TOTAL = ZVSD_INCL_USER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_INCL_USER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_INCL_USER'
...
TOTAL = ZVSD_INCL_USER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_INCL_USER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_INCL_USER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_INCL_USER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_INCL_USER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_INCL_USER_EXTRACT
TOTAL = ZVSD_INCL_USER_TOTAL
