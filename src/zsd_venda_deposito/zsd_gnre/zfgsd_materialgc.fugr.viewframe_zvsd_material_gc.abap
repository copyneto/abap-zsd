*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_MATERIAL_GC
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_MATERIAL_GC    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_MATERIAL_GC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_MATERIAL_GC_EXTRACT
TOTAL = ZVSD_MATERIAL_GC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_MATERIAL_GC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_MATERIAL_GC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_MATERIAL_GC_EXTRACT
TOTAL = ZVSD_MATERIAL_GC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_MATERIAL_GC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_MATERIAL_GC'
...
TOTAL = ZVSD_MATERIAL_GC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_MATERIAL_GC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_MATERIAL_GC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_MATERIAL_GC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_MATERIAL_GC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_MATERIAL_GC_EXTRACT
TOTAL = ZVSD_MATERIAL_GC_TOTAL
