*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_PIS_COFINS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_PIS_COFINS     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_PIS_COFINS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_PIS_COFINS_EXTRACT
TOTAL = ZVSD_PIS_COFINS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_PIS_COFINS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_PIS_COFINS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_PIS_COFINS_EXTRACT
TOTAL = ZVSD_PIS_COFINS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_PIS_COFINS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_PIS_COFINS'
...
TOTAL = ZVSD_PIS_COFINS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_PIS_COFINS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_PIS_COFINS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_PIS_COFINS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_PIS_COFINS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_PIS_COFINS_EXTRACT
TOTAL = ZVSD_PIS_COFINS_TOTAL
