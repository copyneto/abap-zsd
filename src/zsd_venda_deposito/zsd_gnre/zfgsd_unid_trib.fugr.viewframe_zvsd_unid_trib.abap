*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_UNID_TRIB
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_UNID_TRIB      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_UNID_TRIB'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_UNID_TRIB_EXTRACT
TOTAL = ZVSD_UNID_TRIB_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_UNID_TRIB'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_UNID_TRIB-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_UNID_TRIB_EXTRACT
TOTAL = ZVSD_UNID_TRIB_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_UNID_TRIB-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_UNID_TRIB'
...
TOTAL = ZVSD_UNID_TRIB_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_UNID_TRIB-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_UNID_TRIB-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_UNID_TRIB'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_UNID_TRIB-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_UNID_TRIB_EXTRACT
TOTAL = ZVSD_UNID_TRIB_TOTAL
