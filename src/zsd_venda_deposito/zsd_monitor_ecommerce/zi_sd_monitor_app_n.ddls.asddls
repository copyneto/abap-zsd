...
define view entity ZI_SD_MONITOR_APP_N
...

{
  ...
  key          case
               ...
               _FlowRemessa.ActualDate                                                                        as ActualDate,
...
group by
  _SalesOrderView.SalesOrder,
  _FlowRemessa.Remessa,
  _FlowRemessa.Fatura,
  ...
  _SalesOrderView.PurchaseOrderByCustomer,
  _SalesOrderView.CreationDate,
  _SalesOrderView.DistributionChannel,
  _SalesOrderView.CreationTime,
  _SalesOrderView.DeliveryBlockReason,
  _Param.OrderType,
  _FlowRemessa.OrdemFrete,
  _SalesOrderView.OverallSDDocumentRejectionSts,
  _FlowRemessa.BR_NotaFiscal,
  _FlowRemessa.UnidadeFrete,
  _FlowRemessa.BillingDocumentIsCancelled,
  _FlowRemessa.ShippingPoint,
  _SalesOrderView.Plant,
  _CustomerRegion.Region,
  _FlowRemessa.BR_NFIsPrinted,
  _FlowRemessa.BR_NFeDocumentStatus,
  _SalesOrderView.Plant,
  _CustomerRegion.Region,
  _FlowRemessa.CreationDate,
  _FlowRemessa.CreationTime,
  _Pick.CreationDate,
  _Pick.CreationTime,
  _FlowRemessa.ActualGoodsMovementDate,
  _FlowRemessa.ActualGoodsMovementTime,
  _FlowRemessa.CreationDateFatura,
  _FlowRemessa.CreationTimeFatura,
  _FlowRemessa.ActualDateSaida,
  _FlowRemessa.DateSaida,
  _FlowRemessa.HoraSaida,
  _FlowRemessa.ActualDate,
  _Plant.PlantName
