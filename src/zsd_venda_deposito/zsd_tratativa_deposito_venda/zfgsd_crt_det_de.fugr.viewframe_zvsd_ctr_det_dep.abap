*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSD_CTR_DET_DEP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSD_CTR_DET_DEP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSD_CTR_DET_DEP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSD_CTR_DET_DEP_EXTRACT
TOTAL = ZVSD_CTR_DET_DEP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSD_CTR_DET_DEP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSD_CTR_DET_DEP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_CTR_DET_DEP_EXTRACT
TOTAL = ZVSD_CTR_DET_DEP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSD_CTR_DET_DEP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSD_CTR_DET_DEP'
...
TOTAL = ZVSD_CTR_DET_DEP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSD_CTR_DET_DEP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSD_CTR_DET_DEP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSD_CTR_DET_DEP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSD_CTR_DET_DEP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSD_CTR_DET_DEP_EXTRACT
TOTAL = ZVSD_CTR_DET_DEP_TOTAL
